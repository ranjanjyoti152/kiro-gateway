...
│   ├── test_config.py              # Configuration tests (SERVER_HOST, SERVER_PORT, LOG_LEVEL, management host, Account System constants)
...
│   ├── test_model_discovery.py     # Live model discovery tests (management host, pagination, fallback)
